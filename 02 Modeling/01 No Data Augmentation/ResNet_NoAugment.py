...
# Initialize our pretrained model (ResNet)
...
# Redefine the final resnet layer
resnet.fc = nn.Linear(2048, 1024)


# Create the new model
paw_model = PawModel(pretrained_model=resnet)
...
torch.save(trained_model, 'best_resnet_noaugment.pth')